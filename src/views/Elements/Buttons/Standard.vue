            ...
            <div class="main-card mb-3 card">
              <div class="card-body">
                ...
                <template v-for="variant in ['primary','secondary','success','info','warning','danger','focus','alternate','light','dark','link']">
                  <b-button :key="variant" class="mr-2 mb-2" :variant="variant">
                    {{variant}}
                  </b-button>
                </template>
              </div>
            ...
            <div class="main-card mb-3 card">
              <div class="card-body">
                ...
                <template v-for="variant in ['outline-primary','outline-secondary','outline-success','outline-info','outline-warning','outline-danger','outline-focus','outline-alternate','outline-light','outline-dark','outline-link']">
                  <b-button :key="variant" class="mr-2 mb-2 btn-transition" :variant="variant">
                    {{variant}}
                  </b-button>
                </template>
              </div>
          ...
          <b-col lg="6">
            <div class="main-card mb-3 card">
              <div class="card-body">
                ...
                <template v-for="variant in ['outline-primary','outline-secondary','outline-success','outline-info','outline-warning','outline-danger','outline-focus','outline-alternate','outline-light','outline-dark','outline-link']">
                  <b-button :key="variant" class="mr-2 mb-2 border-0 btn-transition" :variant="variant">
                    {{variant}}
                  </b-button>
                </template>
              </div>
          ...
          <b-col lg="6">
            <div class="main-card mb-3 card">
              <div class="card-body">
                ...
                <template v-for="variant in ['primary','secondary','success','info','warning','danger','focus','alternate','light','dark','link']">
                  <b-button :key="variant" class="mr-2 mb-2 btn-hover-shine btn-transition" :variant="variant">
                    {{variant}}
                  </b-button>
                </template>
              </div>
          ...
          <b-col lg="6">
            <div class="main-card mb-3 card">
              <div class="card-body">
                ...
                <template v-for="variant in ['primary','secondary','success','info','warning','danger','focus','alternate','light','dark','link']">
                  <b-button :key="variant" :pressed="true" class="mr-2 mb-2" :variant="variant">
                    {{variant}}
                  </b-button>
                </template>
              </div>
          ...
          <b-col lg="6">
            <div class="main-card mb-3 card">
              <div class="card-body">
                ...
                <template v-for="variant in ['primary','secondary','success','info','warning','danger','focus','alternate','light','dark','link']">
                  <b-button :key="variant" disabled class="mr-2 mb-2" :variant="variant">
                    {{variant}}
                  </b-button>
                </template>
              </div>
            ...
            <div class="main-card mb-3 card">
              <div class="card-body">
                ...
                <template v-for="size in ['sm','','lg']">
                  <b-button :key="size" block class="mr-2 mb-2" variant="primary" :size="size">
                    Block {{size}}
                  </b-button>
                </template>
              </div>
          ...
          <b-col lg="6">
            <div class="main-card mb-3 card">
              <div class="card-body">
                ...
                <template v-for="size in ['sm','','lg']">
                  <b-button :key="size" class="btn-wide mr-2 mb-2" variant="primary" :size="size">
                    Wider {{size}}
                  </b-button>
                </template>
              </div>
            ...
            <div class="main-card mb-3 card">
              <div class="card-body">
                ...
                <template v-for="size in ['sm','','lg']">
                  <b-button :key="size" class="mr-2 mb-2" variant="primary" :size="size">
                    Button {{size}}
                  </b-button>
                </template>
              </div>
