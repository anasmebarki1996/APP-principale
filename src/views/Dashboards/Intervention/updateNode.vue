        ...
        <div>
          ...
          <b-card bg-variant="light" style="padding-buttom: 200px;">
            ...
            <div class="container">
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" multiple>
                    ...
                    key) in node_to_update.Conseils_instructions" :key="key" :value="instruction"
                      style="cursor: no-drop;" v-on:dblclick="
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" multiple>
                    <option v-for="(engin, key) in node_to_update.decision.intern" :key="key" :value="engin"
                      style="cursor: no-drop;" v-on:dblclick="
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" multiple>
                    <option v-for="(etablissement, key) in node_to_update.decision
                      .extern" :key="key" :value="etablissement" style="cursor: no-drop;" v-on:dblclick="
              ...
              <button type="button" class="btn btn-primary" id="add_submit" v-on:click="submit_node_update()">
                Modifier
              </button>
            </div>
